...
export default function AuditLogPage() {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto w-full bg-[var(--color-bg)] dashboard-root overflow-x-hidden relative">
      <PageHeader 
        title="Audit Log" 
        action={
      ...
      <div className={`p-6 md:p-8 space-y-6 max-w-[1600px] w-full mx-auto transition-all duration-300 ${selectedLog ? 'mr-[420px]' : ''}`}>
        ...
        <div className="flex flex-wrap items-center gap-3 dashboard-section">
          ...
          />
          <select className="h-10 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 text-sm focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] hover:bg-[var(--color-surface-2)]/50 cursor-pointer text-[var(--color-text-primary)]">
            <option value="" disabled selected hidden>Action Type: All</option>
            <option>batch.*</option>
          ...
          <select className="h-10 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 text-sm focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[var(--color-accent)] hover:bg-[var(--color-surface-2)]/50 cursor-pointer text-[var(--color-text-primary)]">
            <option value="" disabled selected hidden>Actor: All</option>
