                        ...
                        <Card className='p-6 border-border'>
                            <div className="flex items-center gap-3 mb-8 px-1">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Select the session and department for this batch</p>
                                </div>
                            </div>
                                ...
                                <div className='space-y-4 md:col-span-2'>
                                    ...
                                    <label
                                        className={cn(
                                            ...
                                            autoDispatch && "border-sidebar-primary/30 bg-sidebar-primary/5"
                                        )}
                                    >
                                        <div className='space-y-1 select-none flex-1'>
                                            ...
                                            <p className='text-muted-foreground text-xs leading-relaxed'>
                                                Deliver results to parents via Email and WhatsApp immediately after a successful upload.
                                            </p>
                                        </div>
                        ...
                        <Card className='p-6 border-border'>
                            <div className="flex items-center gap-3 mb-8 px-1">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Upload a CSV or PDF file containing the result data</p>
                                </div>
                            </div>
                            ...
                            {!file ? (
                                ...
                                >
                                    ...
                                    <p className='text-sm text-muted-foreground mb-8 max-w-xs'>
                                        Drag and drop your result file here, or click to browse from your device.
                                    </p>
                                    ...
                                    <div className='flex items-center gap-6 px-4 py-2 bg-card rounded-full border border-border text-[10px] font-bold uppercase tracking-widest text-muted-foreground '>
                                        <span className="flex items-center gap-1.5"><FileType className="h-3 w-3" /> CSV or PDF</span>
                                    ...
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                <Badge variant="secondary" className="px-1.5 py-0 text-[10px] bg-sidebar-primary/10 text-sidebar-primary border-none">
                                ...
                                <div className='p-6 border-b border-border'>
                                    <div className="flex items-center gap-3 mb-8 px-1">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Verify the extracted data before final submission</p>
                                        </div>
                                    </div>

                                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-8'>
                                        <div className='rounded-xl border border-border bg-muted/20 p-4 space-y-1'>
                                            <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Records Found</p>
                                            <p className="text-xl font-bold text-foreground">{validation.rowCount}</p>
                                        </div>
                                        <div className='rounded-xl border border-border bg-muted/20 p-4 space-y-1'>
                                            <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Unique Students</p>
                                            <p className="text-xl font-bold text-foreground">{validation.studentCount}</p>
                                        </div>
                                        <div className={cn(
                                            "rounded-xl border p-4 space-y-1 transition-colors",
                                            validation.errors.length > 0 ? "border-destructive/20 bg-destructive/5" : "border-emerald-500/20 bg-emerald-500/5"
                                        )}>
                                            <p className={cn(
                                                "text-[10px] font-bold uppercase tracking-wider",
                                                validation.errors.length > 0 ? "text-destructive" : "text-emerald-600"
                                            )}>System Validation</p>
                                            <div className="flex items-center justify-between">
                                                <p className={cn(
                                                    ...
                                                    {validation.errors.length > 0 ? `${validation.errors.length} Issues` : "Passed"}
                                                </p>
                                    ...
                                    {showErrorDetails && validation.errors.length > 0 ? (
                                        <div className='rounded-xl border border-destructive/20 bg-destructive/5 p-6 mb-8 animate-in fade-in duration-300'>
                                            <div className="flex items-center gap-2 text-destructive mb-4">
                                                ...
                                                <h4 className="text-sm font-bold">Critical Validation Errors</h4>
                                            </div>
                                            <div className="space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                                                {validation.errors.slice(0, 50).map((error, idx) => (
                                                    <div key={idx} className="flex items-start gap-2 text-xs text-destructive/80 font-medium bg-white/50 p-2 rounded-lg border border-destructive/10">
                                    ...
                                    <div className='space-y-4'>
                                        <div className="flex items-center justify-between px-1">
                                            ...
                                            <Badge variant="outline" className="font-bold">Top 5 Rows</Badge>
                                        </div>
                                            ...
                                            <DataTable
                                                ...
                                                columns={[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        className: "px-4 py-3",
                                                        cell: (row: any) => (
                                                            <Badge variant="secondary" className="font-bold min-w-8 justify-center">
                                                                {row.grade}
                                                            </Badge>
                                                        )
                                                    },
                            ...
                            <Card className='border-emerald-500/20 bg-emerald-500/5 p-6 animate-in zoom-in-95 duration-300'>
                                ...
                                <div className="space-y-4">
                                    <p className="text-sm text-emerald-700/80 leading-relaxed">
                                        Successfully processed results for <span className="font-bold text-emerald-700">{submitSuccess.students} students</span>.
                                        Batch ID: <span className="font-mono bg-emerald-100 px-1.5 py-0.5 rounded text-xs">{submitSuccess.batchId}</span>
                                    </p>
                                    ...
                                    <div className='flex flex-wrap gap-3 pt-2'>
                                        <Button asChild variant="outline" className="bg-white hover:bg-emerald-50 text-emerald-700 border-emerald-200">
                                        ...
                                        {submitSuccess.dispatchId && (
                                            <Button asChild className="bg-emerald-600 hover:bg-emerald-700 text-white">
                                                <Link href={`/admin/delivery/${submitSuccess.dispatchId}`}>
                                                    Track Delivery
                                                </Link>
                                            </Button>
                                        )}
                    ...
                    <div className='xl:sticky xl:top-24 h-fit space-y-6'>
                        <Card className='p-6 border-border bg-muted/20'>
                            ...
                            <p className='text-xs text-muted-foreground leading-relaxed mb-6'>
                                Please ensure your file follows the standard format to avoid extraction errors.
                            </p>
                            ...
                            <div className='space-y-6 mb-8'>
                                <div className="space-y-3">
                                    ...
                                    <div className='flex flex-wrap gap-1.5'>
                                        {["matric_number", "student_name", "department", "course_code", "grade", "unit"].map(col => (
                                            <span key={col} className="text-[10px] font-mono bg-card px-2 py-1 rounded border border-border text-foreground/80">
                                                {col}
                                            </span>
                                        ))}
                                    </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className='flex flex-wrap gap-1.5'>
                                        {["parent_phone", "parent_email", "score"].map(col => (
                                            <span key={col} className="text-[10px] font-mono bg-card/50 px-2 py-1 rounded border border-border text-muted-foreground">
                                                {col}
                                            </span>
                                        ))}
                                    </div>
                        ...
                        <div className="rounded-2xl bg-sidebar-primary p-6 text-white">
                            ...
                            <p className="text-xs text-sidebar-primary-foreground/80 leading-relaxed mb-4">
                                If you're having trouble with PDF extraction, try converting to CSV or contact the SIS administrator.
                            </p>
                            <Button variant="secondary" className="w-full text-xs h-9 bg-white/10 hover:bg-white/20 border-none text-white">
                                Contact Support
                            </Button>
                        </div>
                    </div>
