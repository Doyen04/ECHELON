    ...
    <div className='dashboard-root flex h-full w-full flex-col overflow-y-auto bg-background'>
      ...
      <main className='mx-auto w-full max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8 pb-24'>
        <div className='flex flex-col gap-8 lg:flex-row'>
            ...
            <div className='space-y-4'>
              {student.studentResults.map((result: any, index: number) => {
                ...
                return (
                  <div
                    key={result.id}
                    className='overflow-hidden rounded-xl border border-border-subtle bg-surface-main shadow-sm'
                      ...
                      <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
                        <div className='flex items-center gap-6'>
                          <div className='flex items-center gap-2'>
                            <div
                              className={`rounded p-1 text-text-muted ${isExpanded ? "bg-surface-subtle" : ""}`}
                            >
                              {isExpanded ? (
                            ...
                            <div>
                              ...
                              <div className='text-sm text-text-muted'>
                                {semesterLabel(result.batch.semester)} •{" "}
                                {result.batch.department}
                              </div>
                            </div>
                          </div>
                            ...
                            columns={[
                              {
                                ...
                                accessorKey: "code",
                                className:
                                  "w-24 px-4 py-2 font-mono text-text-muted",
                              },
                              {
                                header: "Title",
                                accessorKey: "title",
                              ...
                              },
                              {
                                header: "Units",
                                accessorKey: "unit",
                                className: "w-16 px-4 py-2 text-foreground",
                              },
                              {
                                header: "Grade",
                                accessorKey: "grade",
                                className:
                                  "w-16 px-4 py-2 font-medium text-foreground",
                              },
                            ]}
                          />
                        </div>
          ...
          <Card
            className='space-y-6 p-6 lg:min-w-90 xl:w-[35%] dashboard-section shadow-sm'
          ...
          >
            ...
            <div className='space-y-4'>
              ...
              <Button
                variant='outline'
                className='flex w-full items-center justify-center gap-2 rounded-full border-dashed'
              >
