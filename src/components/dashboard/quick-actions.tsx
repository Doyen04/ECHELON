...
export function QuickActions() {
  return (
    <SectionFrame
      ...
      description="Task shortcuts and compliance guardrails for the registrar team"
    >
      <div className="space-y-4">
        {actions.map((item) => (
          ...
          >
            ...
            <a
              href={item.href}
              className="mt-4 inline-flex rounded-lg border border-[var(--border-strong)] px-3 py-2 text-xs font-semibold text-[var(--text-primary)] transition hover:bg-[var(--surface-muted)]"
            >
              {item.cta}
            </a>
          </article>
