export function PageHeader() {
  return (
    <header className="dashboard-header relative overflow-hidden rounded-3xl border border-[var(--border-strong)] bg-[linear-gradient(135deg,var(--hero-deep),var(--hero-mid)_52%,var(--hero-accent))] px-6 py-7 text-[var(--hero-text)] shadow-[0_25px_60px_-30px_rgba(2,23,23,0.75)] md:px-8 md:py-9">
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-[var(--hero-kicker)]">
            Result Notification System
          </p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-[var(--hero-text)] sm:text-4xl lg:text-5xl">
            Parent Result Dispatch Dashboard
          </h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[var(--hero-subtle)] sm:text-base">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/20 bg-black/20 px-4 py-3 text-xs text-[var(--hero-subtle)] sm:col-span-2">
